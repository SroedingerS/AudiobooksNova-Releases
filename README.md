...
Актуальная версия: **2.9.1v**. Исправлены видимость фокуса и долгое нажатие пульта на ТВ; устранены параллельные загрузки обновления при повторных нажатиях. [Описание изменений](RELEASE-2.9.1v.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.1v/AudiobooksNova-2.9.1v.apk).
