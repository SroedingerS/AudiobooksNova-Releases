...
Актуальная версия: **2.9.2u**. Исправлен вылет после обновления со старых версий, усилена безопасная миграция данных, а виджет теперь сохраняет длительность главы и не запускает бесконечную шкалу в состоянии паузы. [Описание изменений](RELEASE-2.9.2u.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2u/AudiobooksNova-2.9.2u.apk).
