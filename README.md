...
Актуальная версия: **2.9.2k**. Интерфейс автоматически подстраивается под телефон, планшет и телевизор; телефонная альбомная библиотека и портретные карточки обновлены по выбранным макетам. [Описание изменений](RELEASE-2.9.2k.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2k/AudiobooksNova-2.9.2k.apk).
