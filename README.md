...
Актуальная версия: **2.9.4k**. Исправлена причина повторного проигрывания конца главы в фоне и после запуска с виджета; восстановление при реальном обрыве аудио сохранено. [Описание изменений](RELEASE-2.9.4k.md) · [Все изменения](CHANGELOG.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.4k/AudiobooksNova-2.9.4k.apk).
