...
Актуальная версия: **2.9.2j**. Библиотека получила адаптивные карточки и закреплённый акцент текущей книги, а для высоких альбомных экранов добавлен отдельный полноразмерный плеер. [Описание изменений](RELEASE-2.9.2j.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2j/AudiobooksNova-2.9.2j.apk).
