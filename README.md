...
Актуальная версия: **2.9.3p**. Добавлено удаление всех офлайн-файлов книги из плеера, таймер сна запоминает выбранное время и предупреждает перед остановкой, а карусель «Слушаю сейчас» больше не повторяет книги. [Описание изменений](RELEASE-2.9.3p.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.3p/AudiobooksNova-2.9.3p.apk).
