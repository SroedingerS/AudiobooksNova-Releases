...
Актуальная версия: **2.9.2g**. Проверка обновлений переведена на устойчивую схему с двумя публичными адресами и больше не зависит от общего лимита GitHub API. [Описание изменений](RELEASE-2.9.2g.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2g/AudiobooksNova-2.9.2g.apk).
