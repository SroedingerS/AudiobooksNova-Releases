...
Актуальная версия: **2.9.3n**. Исправлены скругления и границы полосы прогресса, а слой предзагрузки больше не примыкает к указателю и конечному маркеру. [Описание изменений](RELEASE-2.9.3n.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.3n/AudiobooksNova-2.9.3n.apk).
