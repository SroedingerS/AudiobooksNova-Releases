...
Актуальная версия: **2.9.2l**. Телефонная библиотека получила устойчивую адаптацию карточек, обложек и навигации к ориентации экрана и выбранному размеру текста. [Описание изменений](RELEASE-2.9.2l.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2l/AudiobooksNova-2.9.2l.apk).
