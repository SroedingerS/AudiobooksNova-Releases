...
Актуальная версия: **2.9.3m**. Возвращён прежний вид полосы прогресса плеера, а предзагрузка теперь показана мягким оттенком внутри неё. [Описание изменений](RELEASE-2.9.3m.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.3m/AudiobooksNova-2.9.3m.apk).
