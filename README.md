...
Актуальная версия: **2.9.2d**. Исправлены компоновка плеера на телевизорах и высоких телефонах, отображение обложек скачанных циклов и сворачиваемая панель каталога. [Описание изменений](RELEASE-2.9.2d.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2d/AudiobooksNova-2.9.2d.apk).
