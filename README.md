...
Актуальная версия: **2.9.4j**. Улучшены окна плеера, переходы между главами, поиск и открытие книг из уведомлений; добавлена длительность глав. [Описание изменений](RELEASE-2.9.4j.md) · [Все изменения](CHANGELOG.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.4j/AudiobooksNova-2.9.4j.apk).
