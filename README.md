...
Актуальная версия: **2.9.2s**. На Android TV появились два выбираемых варианта плеера: атмосферная сцена с обложкой и классическая библиотека; оба полностью управляются пультом и масштабируются под разрешение телевизора. [Описание изменений](RELEASE-2.9.2s.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2s/AudiobooksNova-2.9.2s.apk).
