...
Актуальная версия: **2.9.3c**. Поиск показывает отдельные озвучки одной книги с разными чтецами; их прогресс прослушивания больше не смешивается. [Описание изменений](RELEASE-2.9.3c.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.3c/AudiobooksNova-2.9.3c.apk).
