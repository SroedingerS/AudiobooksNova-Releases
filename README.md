...
Актуальная версия: **2.9.2q**. В телефонные двухколоночные карточки возвращена компактная строка «Описание» с открытием полного текста; высота пары учитывает её только тогда, когда описание действительно присутствует. [Описание изменений](RELEASE-2.9.2q.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2q/AudiobooksNova-2.9.2q.apk).
