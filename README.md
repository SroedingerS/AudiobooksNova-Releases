...
Актуальная версия: **2.9.2c**. Исправлены видимость обложек цикла, адаптация плеера по высоте и ложная ошибка проверки подписи APK на отдельных устройствах. [Описание изменений](RELEASE-2.9.2c.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2c/AudiobooksNova-2.9.2c.apk).
