...
Актуальная версия: **2.9.2f**. Добавлены пользовательские обложки во всём приложении, исправлены обрезание тонарма и возврат верхнего блока каталога, повышена стабильность первого запуска. [Описание изменений](RELEASE-2.9.2f.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2f/AudiobooksNova-2.9.2f.apk).
