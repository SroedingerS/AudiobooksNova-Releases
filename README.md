...
Актуальная версия: **2.9.2m**. Единый дизайн карточек распространён на каталог, поиск, новинки и рекомендации; исправлены маленькие обложки с полями и ускорена фильтрация жанров. [Описание изменений](RELEASE-2.9.2m.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2m/AudiobooksNova-2.9.2m.apk).
