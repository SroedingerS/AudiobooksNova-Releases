...
Актуальная версия: **2.9.2n**. Телефонные двухколоночные карточки исправлены по библиотечному макету: возвращены боковые действия, убраны лишние пустые области и разделены пиктограммы цикла и жанра. [Описание изменений](RELEASE-2.9.2n.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2n/AudiobooksNova-2.9.2n.apk).
