...
Актуальная версия: **2.9.1t**. Улучшены загрузка и отмена книг и циклов, проверка целостности файлов, получение глав Audioknigi.PRO и СлушКинВсем; добавлено сохранение поддерживаемых HLS-глав. [Описание изменений](RELEASE-2.9.1t.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.1t/AudiobooksNova-2.9.1t.apk).
