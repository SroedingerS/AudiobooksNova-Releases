...
Актуальная версия: **2.9.2p**. Отображение обложек в карточках возвращено к проверенной реализации: исходное изображение снова заполняет блок без адаптивного уменьшения, дополнительного кадрирования и повторного JPEG-сжатия. [Описание изменений](RELEASE-2.9.2p.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2p/AudiobooksNova-2.9.2p.apk).
