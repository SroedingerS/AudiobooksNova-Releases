...
Актуальная версия: **2.9.3e**. Исправлены поиск по автору и чтецу и переход между страницами результатов; предыдущие исправления точного поиска и поиска по циклу сохранены. [Описание изменений](RELEASE-2.9.3e.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.3e/AudiobooksNova-2.9.3e.apk).
