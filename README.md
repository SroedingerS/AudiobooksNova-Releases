...
Актуальная версия: **2.9.3d**. Исправлены поиск по точному названию и по циклу; разные озвучки одной книги больше не скрываются. [Описание изменений](RELEASE-2.9.3d.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.3d/AudiobooksNova-2.9.3d.apk).
