...
Актуальная версия: **2.9.1q**. В ней TV-меню книги получило отдельный предсказуемый контроллер пульта, а проверка обновлений после холодного запуска стала устойчивее к позднему подключению сети.
