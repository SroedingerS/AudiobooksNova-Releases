...
Актуальная версия: **2.9.2o**. Телефонные двухколоночные карточки больше не растягиваются старым минимальным размером, необязательные строки рассчитываются для каждой пары, а маленькие обложки с полями автоматически распознаются заново. [Описание изменений](RELEASE-2.9.2o.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2o/AudiobooksNova-2.9.2o.apk).
...
Служебная папка `updates` очищается от уже установленных APK и остатков прерванных загрузок при запуске и перед новым скачиванием. Ещё не установленное более новое обновление сохраняется; книги и пользовательские данные не затрагиваются.
