...
Актуальная версия: **2.9.1r**. В ней исправлены внешние плейлисты и синхронизация точного варианта книги, добавлен таймер до конца главы и улучшено управление настройками с пульта Android TV.
