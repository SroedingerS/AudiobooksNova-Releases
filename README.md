...
- интерфейс и навигация с пульта для Android TV.
...
Nova может проверить этот публичный репозиторий и предложить новую версию. Автоматическое предложение показывается не более трёх раз для одного релиза; ручная проверка остаётся в настройках.
