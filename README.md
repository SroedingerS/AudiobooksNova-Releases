...
Актуальная версия: **2.9.2t**. Оба варианта плеера Android TV и высокий альбомный плеер теперь используют выбранную пользователем палитру Nova, включая собственный акцентный цвет. [Описание изменений](RELEASE-2.9.2t.md) · [Скачать APK](https://github.com/SroedingerS/AudiobooksNova-Releases/releases/download/v2.9.2t/AudiobooksNova-2.9.2t.apk).
